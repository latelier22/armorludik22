...
const ListeActionsGauche = ({ actions, listeTitle, listeSubTitle, photo , gauche}) => {
  useEffect(() => {
    const init = async () => {
  ...
  return (
    ...
    <img
      ...
      <section className="container mx-auto mt-8 p-4">
        <h1 className="text-4xl font-bold text-center mb-4" style={{ fontFamily: 'knicknack-font'}}>{listeTitle}</h1>
