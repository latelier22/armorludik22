...
const logo = "logo-le-repaire-des-petit-loups.png"
  ...
  <img
    src={`images/${logo}`}
    className="h-full md:h-1/3 w-auto absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-bounceAndStabilize animate-bounceAndStabilizeCenterX"
